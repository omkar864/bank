...
const LoanApplicationForm = ({
  ...
  const onBlurTranslate = useCallback(async (
    sourceValue: string | undefined,
    targetField: keyof LoanApplicationFormValues
  ) => {
    if (sourceValue && !getValues(targetField)) {
        try {
            const translatedText = await translateToHindi(sourceValue);
            setValue(targetField, translatedText);
        } catch (e) {
            console.error("Translation error:", e);
        }
    }
  }, [getValues, setValue, translateToHindi]);
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              <fieldset className="border p-4 rounded-lg">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 pt-4">
                      <FormField control={form.control} name="customerName" render={({ field }) => (<FormItem><FormLabel>Customer Name</FormLabel><FormControl><Input placeholder="Customer Name" {...field} disabled={isFormDisabled} onBlur={(e) => onBlurTranslate(e.target.value, 'customerNameHindi')} /></FormControl><FormMessage /></FormItem>)} />
                      ...
                      <FormField control={form.control} name="dateOfBirth" render={({ field }) => (<FormItem><FormLabel>Date of Birth</FormLabel><FormControl><Input type="date" {...field} disabled={isFormDisabled} /></FormControl><FormMessage /></FormItem>)} />
                      ...
                      <FormField control={form.control} name="fatherName" render={({ field }) => (<FormItem><FormLabel>Father’s Name</FormLabel><FormControl><Input placeholder="Father’s Name" {...field} disabled={isFormDisabled} onBlur={(e) => onBlurTranslate(e.target.value, 'fatherNameHindi')} /></FormControl><FormMessage /></FormItem>)} />
                      ...
                      <FormField control={form.control} name="motherName" render={({ field }) => (<FormItem><FormLabel>Mother’s Name</FormLabel><FormControl><Input placeholder="Mother’s Name" {...field} disabled={isFormDisabled} onBlur={(e) => onBlurTranslate(e.target.value, 'motherNameHindi')} /></FormControl><FormMessage /></FormItem>)} />
                      ...
                      <FormField control={form.control} name="husbandWifeName" render={({ field }) => (<FormItem><FormLabel>Spouse's Name (optional)</FormLabel><FormControl><Input placeholder="Spouse's Name" {...field} disabled={isFormDisabled} onBlur={(e) => onBlurTranslate(e.target.value, 'husbandWifeNameHindi')} /></FormControl><FormMessage /></FormItem>)} />
                      ...
                      <FormField control={form.control} name="mobileNumber" render={({ field }) => (<FormItem><FormLabel>Mobile Number</FormLabel><FormControl><Input placeholder="Mobile Number" {...field} disabled={isFormDisabled} /></FormControl><FormMessage /></FormItem>)} />
                      <FormField control={form.control} name="alternateMobileNumber" render={({ field }) => (<FormItem><FormLabel>Alternate Mobile (optional)</FormLabel><FormControl><Input placeholder="Alternate Mobile" {...field} disabled={isFormDisabled} /></FormControl><FormMessage /></FormItem>)} />
                  </div>
              </fieldset>
              ...
              <fieldset className="border p-4 rounded-lg">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 pt-4">
                      <FormField control={form.control} name="residentialAddress" render={({ field }) => (<FormItem className="md:col-span-2"><FormLabel>Residential Address</FormLabel><FormControl><Textarea placeholder="Residential Address" {...field} disabled={isFormDisabled} onBlur={(e) => onBlurTranslate(e.target.value, 'residentialAddressHindi')} /></FormControl><FormMessage /></FormItem>)} />
                      
                      <FormField control={form.control} name="city" render={({ field }) => (<FormItem><FormLabel>City</FormLabel><FormControl><Input placeholder="City" {...field} disabled={isFormDisabled} onBlur={(e) => onBlurTranslate(e.target.value, 'cityHindi')} /></FormControl><FormMessage /></FormItem>)} />
                      ...
                      <FormField control={form.control} name="state" render={({ field }) => (<FormItem><FormLabel>State</FormLabel><FormControl><Input placeholder="State" {...field} disabled={isFormDisabled} onBlur={(e) => onBlurTranslate(e.target.value, 'stateHindi')} /></FormControl><FormMessage /></FormItem>)} />
                      ...
                      <FormField control={form.control} name="pincode" render={({ field }) => (<FormItem><FormLabel>Pincode</FormLabel><FormControl><Input placeholder="Pincode" type="number" disabled={isFormDisabled} onBlur={(e) => onBlurTranslate(e.target.value, 'pincodeHindi')} /></FormControl><FormMessage /></FormItem>)} />
                      ...
                      <FormField control={form.control} name="permanentAddress" render={({ field }) => (<FormItem className="md:col-span-2"><FormLabel>Permanent Address</FormLabel><FormControl><Textarea placeholder="Permanent Address" {...field} disabled={isFormDisabled} onBlur={(e) => onBlurTranslate(e.target.value, 'permanentAddressHindi')} /></FormControl><FormMessage /></FormItem>)} />
                      
                      <FormField control={form.control} name="companyShopName" render={({ field }) => (<FormItem><FormLabel>Company/Shop Name</FormLabel><FormControl><Input placeholder="Company/Shop Name" {...field} disabled={isFormDisabled} /></FormControl><FormMessage /></FormItem>)} />
                      <FormField control={form.control} name="companyShopAddress" render={({ field }) => (<FormItem><FormLabel>Company/Shop Address</FormLabel><FormControl><Textarea placeholder="Company/Shop Address" {...field} disabled={isFormDisabled} /></FormControl><FormMessage /></FormItem>)} />
                  </div>
              </fieldset>
